...
png("/Users/sarahjw2/Box/Widener_Lipka_Shared_Folder/TLI/Genomic_Selection/H4/Simulation/combined_boxplots_H4_30QTN.png", 
...
generate_boxplot("30 small qtl H0.2", "H4", file_paths_1)
generate_boxplot("30 small qtl H0.5", "H4", file_paths_2)
generate_boxplot("30 small qtl H0.8", "H4", file_paths_3)
...
# Generate boxplots for all three settings and show them side by side
generate_boxplot("30 small qtl H0.2", "H4", file_paths_1)
generate_boxplot("20 small qtl H0.5", "H4", file_paths_2)
generate_boxplot("30 small qtl H0.8", "H4", file_paths_3)

# Add a centered title across the entire plot
mtext("H4 with 30 GTL", side = 3, line = 1, cex = 4, font = 2, col = "black", outer = TRUE)
