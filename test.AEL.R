#Simmulations
setwd("/Users/alipka/Library/CloudStorage/Box-Box/Widener_Lipka_Shared_Folder/TLI/Genomic_Selection/Initial_Test_Pipeline/H4/Simulation/")
home.dir <- getwd()
...
#data install
data <- read.delim("Genotype.H4.rf.filter.in.Hapmap.Format.NA.as.N.txt", head = TRUE)
View(data)
