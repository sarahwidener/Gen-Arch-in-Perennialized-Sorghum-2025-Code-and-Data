...
png("/Users/sarahjw2/Box/Widener_Lipka_Shared_Folder/TLI/Genomic_Selection/H4/Simulation/combined_boxplots_H4_15QTN.png", 
...
generate_boxplot("15 medium qtl H0.2", "H4", file_paths_1)
generate_boxplot("15 medium qtl H0.5", "H4", file_paths_2)
generate_boxplot("15 medium qtl H0.8", "H4", file_paths_3)
...
mtext("H4 with 15 QTL", side = 3, line = 1, cex = 4, font = 2, col = "black", outer = TRUE)
