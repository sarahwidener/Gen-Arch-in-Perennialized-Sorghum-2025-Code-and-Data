...
#H4 Large QTL heritability 0.8 GBLUP VS MultiBLUP wilkoxin sighned rank test
...
# Read the CSV files
multiblup_data <- read_csv("Simulated_Traits/Large qtl H0.8/Mean.5.fold.CV.PA.H4.Large qtl H0.8.GBLUP.csv")
gblup_data <- read_csv("Simulated_Traits/Large qtl H0.8/Mean.5.fold.CV.PA.H4.Large qtl H0.8.multiBLUP.csv")
